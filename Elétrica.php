...
<head>
    ...
    <section class="section section_welcome construcaodeGalpao " data-parallax="scroll" data-image-src="imagem/slide6.jpg">
            <!-- Content -->
                    ...
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            <p class="section__subheading section_welcome__subheading text-center text-muted">
                                Toda fiação e elétrica da sua casa como nova!   
                            </p>
