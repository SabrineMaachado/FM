...
<head>
    ...
    <section class="section section_welcome construcaodeGalpao " data-parallax="scroll" data-image-src="imagem/slide2.jpg">
            <!-- Content -->
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col">
                            ...
                            Construção de galpão pré moldado, construção de galpão em  estrutura metálica, reforma de galpão em geral
                            </p>
                        ...
                        <div class="col-md">
                            ...
                            <div class="section_welcome__footer__address text-center text-lg-right">
                                <i class="fas fa-envelope"></i> construcaofmc@gmail.com
                            </div>
